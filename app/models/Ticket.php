...
class Ticket extends Model {
    ...
    /**
     * جلب جميع التذاكر مع بيانات العميل والموظف المعين
     *
     * @return array مصفوفة ببيانات التذاكر
     */
     ...
     *
     * @param int $id معرف التذكرة
     * @return object|null كائن ببيانات التذكرة أو null
     */
    ...
    public function createTicket(array $data): bool {
        ...
        $this->db->bind(':status', 'open'); // تبدأ دائماً مفتوحة
