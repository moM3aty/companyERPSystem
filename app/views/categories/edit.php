...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <div class="card-header bg-light">
        <h3 class="card-title text-dark"><i class="fas fa-pen text-accent"></i> تعديل بيانات التصنيف</h3>
    </div>
    ...
    <form action="<?php echo URLROOT; ?>/category/edit/<?php echo $category->id; ?>" method="POST">
        ...
        <div class="card-footer d-flex gap-3 bg-light">
            ...
            <a href="<?php echo URLROOT; ?>/category/index" class="btn btn-secondary">إلغاء الرجوع</a>
        </div>
    </form>
</div>