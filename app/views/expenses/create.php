...
$pageTitle = $data['title'] ?? 'تسجيل مصروف';
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-header-card { background: linear-gradient(135deg, var(--danger) 0%, #b91c1c 100%); border-radius: var(--radius); padding: 28px 32px; color: #fff; margin-bottom: 24px; position: relative; overflow: hidden; animation: fadeUp 0.5s ease both; }
        ...
        .btn-submit { display: inline-flex; align-items: center; gap: 8px; padding: 12px 32px; background: linear-gradient(135deg, var(--danger), #b91c1c); color: #fff; border: none; border-radius: var(--radius-sm); font-family: 'Cairo', sans-serif; font-size: 14px; font-weight: 700; cursor: pointer; transition: all 0.25s; box-shadow: 0 4px 15px rgba(239,68,68,0.25); }
...
<body>
    ...
    <div class="main-content">
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                ...
                <div>
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/expense/index">المحاسبة والمالية</a>
                        <i class="fas fa-chevron-left" style="font-size:9px;"></i>
        ...
        <div class="page-body">
            ...
            <div class="form-header-card">
                <h2><i class="fas fa-file-invoice-dollar"></i> توثيق مصروف جديد</h2>
                <p>قم بتسجيل الفواتير والمصروفات التشغيلية مع تصنيفها لضمان دقة التقارير المالية والضريبية.</p>
            </div>

            <div class="form-card">
                <form action="<?php echo URL_ROOT; ?>/expense/create" method="POST" id="expenseForm" novalidate>
                    
                    <div class="form-section">
                        <div class="form-grid">
                            
                            <div class="form-group full">
                                <label class="form-label">تصنيف المصروف (القسم) <span class="req">*</span></label>
                            ...
                            <div class="form-group">
                                <label class="form-label">المبلغ المالي (ر.س) <span class="req">*</span></label>
                                <input type="number" name="amount" id="amountInput" class="form-input" step="0.01" min="0.01" placeholder="مثال: 500" required style="direction:ltr; text-align:right; font-family:monospace; font-size:16px; font-weight:800; color:var(--danger);">
                            </div>

                            <div class="form-group">
                                <label class="form-label">تاريخ المصروف <span class="req">*</span></label>
                            ...
                            <div class="form-group full">
                                ...
                                <input type="text" name="reference_no" class="form-input" placeholder="مثال: INV-2023-145" style="direction:ltr; text-align:right; font-family:monospace;">
                            </div>

                            <div class="form-group full">
                                <label class="form-label">البيان والملاحظات</label>
                                <textarea name="notes" class="form-input" rows="3" placeholder="اكتب تفاصيل المصروف، مثل سبب الدفع والجهة المستفيدة..."></textarea>
                            </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-submit" id="btnSubmit"><i class="fas fa-check"></i> حفظ الفاتورة</button>
                        <a href="<?php echo URL_ROOT; ?>/expense/index" class="btn-cancel">إلغاء والتراجع</a>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!catSelect.value) { 
                catSelect.style.borderColor = 'var(--danger)'; 
                valid = false;
            } else {
                catSelect.style.borderColor = 'var(--border)';
            }
            ...
            if (!valid) {
                e.preventDefault();
                alert('الرجاء التأكد من اختيار التصنيف وإدخال مبلغ صحيح.');
            } else {
