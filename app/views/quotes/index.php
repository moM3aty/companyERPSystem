...
$pageTitle = $data['title'] ?? 'عروض الأسعار';
$quotes = $data['quotes'] ?? [];
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .qte-num { font-family: monospace; font-size: 13px; font-weight: 700; color: var(--info-dark); background: var(--info-light); padding: 4px 10px; border-radius: 6px; direction: ltr; display: inline-block; }
        .cust-name { font-weight: 700; color: var(--text-dark); display: flex; align-items: center; gap: 8px;}
        .cust-name i { color: var(--text-muted); font-size: 13px; }
        
        .amount-val { font-weight: 800; color: var(--text-dark); font-variant-numeric: tabular-nums; direction: ltr; display: inline-block; }
        .amount-val .curr { font-size: 11px; font-weight: 600; color: var(--text-muted); margin-right: 2px; }
            ...
            <div class="toolbar">
                <div class="toolbar-right">
                    <div class="search-box">
                        <input type="text" id="searchInput" placeholder="ابحث برقم العرض أو العميل..." autocomplete="off">
                        <i class="fas fa-search"></i>
                    </div>
                </div>
                <div>
                    <a href="<?php echo URL_ROOT; ?>/quote/create" class="btn-add">
                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr class="search-row" data-search="<?php echo htmlspecialchars($qte->quote_number . ' ' . ($qte->customer_name ?? '')); ?>">
                                <td style="color:var(--text-muted);font-weight:600;font-size:12px;"><?php echo $qte->id; ?></td>
                                <td><span class="qte-num"><?php echo htmlspecialchars($qte->quote_number); ?></span></td>
                                <td>
                                    <div class="cust-name">
                                ...
                                <td style="text-align:left;">
                                    <span class="amount-val"><?php echo number_format($qte->total_amount, 2); ?> <span class="curr">ر.س</span></span>
                                </td>
                                <td>
                                    <span class="date-val"><i class="far fa-calendar-alt"></i> <?php echo date('Y-m-d', strtotime($qte->created_at)); ?></span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="actions-cell">
                                        <a href="<?php echo URL_ROOT; ?>/quote/show/<?php echo $qte->id; ?>" class="act-btn btn-view" title="عرض وطباعة"><i class="fas fa-eye"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <h4>لا توجد عروض أسعار مسجلة</h4>
                                        <p>ابدأ بإنشاء عرض سعر احترافي لعملائك لزيادة مبيعاتك.</p>
                                        <a href="<?php echo URL_ROOT; ?>/quote/create" class="btn-add" style="display:inline-flex;">
                                            <i class="fas fa-plus"></i> إنشاء عرض سعر
                                        </a>
                                    </div>
                                </td>
