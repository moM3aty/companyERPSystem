    ...
    <style>
        ...
        *::after {
        ...
        .profile-header {
            ...
            padding: 32px;
            border-bottom: 1px solid var(--border);
            background: linear-gradient(to left, var(--card-bg), #f8fafc);
        }
        ...
        .sys-stat-card .ss-val {
            font-size: 24px;
            font-weight: 800;
            color: var(--text-dark);
        }

        .sys-stat-card .ss-lbl {
            font-size: 12px;
            color: var(--text-muted);
            margin-top: 4px;
        }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            ...
            <div class="settings-tabs">
                <button class="tab-btn active" data-tab="company"><i class="fas fa-building"></i> بيانات الشركة</button>
                <button class="tab-btn" data-tab="profile"><i class="fas fa-user-gear"></i> الملف الشخصي</button>
                <button class="tab-btn" data-tab="security"><i class="fas fa-shield-halved"></i> الأمان وكلمة المرور</button>
                <button class="tab-btn" data-tab="system"><i class="fas fa-server"></i> معلومات النظام</button>
            </div>
                ...
                <form action="<?php echo URL_ROOT; ?>/settings/index" method="POST">
                    ...
                    <div class="settings-card">
                        <div class="settings-card-header">
                            ...
                            <div>
                                <h3>بيانات المؤسسة / الشركة</h3>
                                <p>تستخدم هذه البيانات في طباعة الفواتير والتقارير الرسمية.</p>
                            </div>
                        </div>
                        <div class="settings-card-body">
                            <div class="settings-grid">
                                <div class="s-group">
                                    <label class="s-label">الاسم التجاري <span class="req">*</span></label>
                                ...
                                <div class="s-group full">
                                    <label class="s-label">نسبة ضريبة القيمة المضافة (VAT %) <span class="req">*</span></label>
                                    <input type="number" name="tax_rate" class="s-input" value="<?php echo htmlspecialchars($settings['tax_rate'] ?? '15'); ?>" min="0" max="100" step="0.1" style="direction:ltr;text-align:right;" required>
                                    <div class="s-hint"><i class="fas fa-info-circle"></i> يتم تطبيق هذه النسبة بشكل افتراضي عند إنشاء فواتير المبيعات.</div>
                                </div>
                            </div>
                        </div>
                        <div class="s-actions">
                            <button type="submit" class="btn-save"><i class="fas fa-save"></i> حفظ التحديثات</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="settings-card">
                        <div class="profile-header">
                            ...
                            <div class="profile-info">
                                ...
                                <div class="profile-role"><i class="fas fa-shield-halved"></i> <?php echo htmlspecialchars($user->role ?? 'admin'); ?></div>
                            </div>
                        </div>
                        <div class="settings-card-body">
                            <div class="settings-grid">
                                ...
                                <div class="s-group">
                                    <label class="s-label">البريد الإلكتروني (للدخول) <span class="req">*</span></label>
                                ...
                                <div class="s-group">
                                    <label class="s-label">رقم الجوال الخاص</label>
                                ...
                                <div class="s-group">
                                    <label class="s-label">الصلاحية (مُقفل)</label>
                                    <input type="text" class="s-input" value="<?php echo htmlspecialchars($user->role ?? ''); ?>" disabled style="background:#f1f5f9;color:var(--text-muted);">
                                </div>
                            </div>
                        </div>
                        <div class="s-actions">
                            <button type="submit" class="btn-save"><i class="fas fa-user-check"></i> حفظ الملف الشخصي</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="settings-card">
                        <div class="settings-card-header">
                            ...
                            <div>
                                ...
                                <p>لضمان الأمان، يُنصح بتغيير كلمة المرور دورياً واستخدام حروف وأرقام.</p>
                            </div>
                        </div>
                        <div class="settings-card-body">
                            <div class="settings-grid">
                                <div class="s-group full">
                                    ...
                                    <input type="password" name="current_password" class="s-input" required placeholder="أدخل كلمة المرور الحالية للتأكيد">
                                </div>
                                <div class="s-group">
                                ...
                                <div class="s-group">
                                    ...
                                    <div class="ps-label" id="matchLabel" style="margin-top: 6px;"></div>
                                </div>
                            </div>
                        </div>
                        <div class="s-actions">
                            <button type="submit" class="btn-save" style="background:linear-gradient(135deg, var(--danger), #dc2626); box-shadow: 0 4px 15px rgba(239, 68, 68, 0.25);"><i class="fas fa-shield-check"></i> تأكيد التغيير</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="tab-panel" id="panel-system">
                <div class="settings-card">
                    <div class="settings-card-header">
                        ...
                        <div>
                            <h3>معلومات النظام والخادم</h3>
                            <p>تفاصيل تقنية تساعد الدعم الفني في حال وجود مشكلة.</p>
                        </div>
                    </div>
                    <div class="settings-card-body">
                        <div class="sys-info-grid">
                            <div class="sys-info-item"><span class="sii-label"><i class="fas fa-code-branch"></i> إصدار النظام</span><span class="sii-value">v<?php echo htmlspecialchars($sysInfo['app_version'] ?? '2.0.0'); ?></span></div>
                            <div class="sys-info-item"><span class="sii-label"><i class="fab fa-php"></i> إصدار PHP</span><span class="sii-value"><?php echo htmlspecialchars($sysInfo['php_version'] ?? ''); ?></span></div>
                            <div class="sys-info-item"><span class="sii-label"><i class="fas fa-database"></i> قاعدة البيانات</span><span class="sii-value"><?php echo htmlspecialchars($sysInfo['db_name'] ?? ''); ?></span></div>
                            <div class="sys-info-item"><span class="sii-label"><i class="fas fa-clock"></i> المنطقة الزمنية</span><span class="sii-value"><?php echo htmlspecialchars($sysInfo['timezone'] ?? ''); ?></span></div>
                            <div class="sys-info-item"><span class="sii-label"><i class="fas fa-upload"></i> الحد الأقصى للرفع</span><span class="sii-value"><?php echo htmlspecialchars($sysInfo['max_upload'] ?? ''); ?></span></div>
                            <div class="sys-info-item"><span class="sii-label"><i class="fas fa-memory"></i> حد الذاكرة لـ PHP</span><span class="sii-value"><?php echo htmlspecialchars($sysInfo['memory_limit'] ?? ''); ?></span></div>
                        </div>

                        <div class="sys-stats-grid">
                            <div class="sys-stat-card">
                                <i class="fas fa-users" style="color:var(--info);"></i>
                                <div class="ss-val"><?php echo number_format($sysStats['employees'] ?? 0); ?></div>
                                <div class="ss-lbl">إجمالي الموظفين</div>
                            </div>
                            <div class="sys-stat-card">
                                <i class="fas fa-box-open" style="color:var(--accent);"></i>
                                <div class="ss-val"><?php echo number_format($sysStats['products'] ?? 0); ?></div>
                                <div class="ss-lbl">المنتجات بالمخزون</div>
                            </div>
                            <div class="sys-stat-card">
                                <i class="fas fa-file-invoice" style="color:var(--success);"></i>
                                <div class="ss-val"><?php echo number_format($sysStats['invoices'] ?? 0); ?></div>
                                <div class="ss-lbl">الفواتير المصدرة</div>
                            </div>
                            <div class="sys-stat-card">
                                <i class="fas fa-money-bill-wave" style="color:var(--danger);"></i>
                                <div class="ss-val"><?php echo number_format($sysStats['expenses'] ?? 0); ?></div>
                                <div class="ss-lbl">سجلات المصروفات</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function checkStrength(pass) {
            ...
            checkMatch(); // تحديث التحقق من التطابق
        }
        ...
        function checkMatch() {
            ...
            if (cp.length === 0) {
                ...
                label.innerHTML = '<i class="fas fa-check"></i> متطابقتان';
                label.style.color = 'var(--success)';
            } else {
                label.innerHTML = '<i class="fas fa-times"></i> غير متطابقتان';
                label.style.color = 'var(--danger)';
            }
        }

        // تفاعل عند الإرسال (تغيير الزر إلى تحميل)
        document.querySelectorAll('form').forEach(form => {
            form.addEventListener('submit', function() {
                ...
                if (btn) {
                    ...
                    // يعود لشكله الطبيعي إذا حدث توقف
                    setTimeout(() => {
