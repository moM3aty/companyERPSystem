...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .summary-card:nth-child(2) .sc-icon { background: var(--success-light); color: var(--success); }
        .summary-card:nth-child(3) .sc-icon { background: var(--info-light); color: var(--info); }
        ...
        .wh-code { font-family: monospace; font-size: 13px; font-weight: 700; color: var(--primary-dark); background: var(--primary-light); padding: 4px 10px; border-radius: 6px; direction: ltr; display: inline-block; }
        .wh-name { font-weight: 700; color: var(--text-dark); display: block;}
        .wh-addr { font-size: 12px; color: var(--text-muted); display: block; margin-top: 2px;}
        
        .badge { display: inline-flex; align-items: center; gap: 5px; padding: 4px 12px; border-radius: 8px; font-size: 11px; font-weight: 700; }
        .badge-main { background: var(--success-light); color: #15803d; border: 1px solid #bbf7d0;}
        .badge-sub { background: var(--page-bg); color: var(--text-body); border: 1px solid var(--border);}
