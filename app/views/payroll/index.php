...
$pageTitle = $data['title'] ?? 'مسير الرواتب';
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .pay-ref { font-family: monospace; font-size: 13px; font-weight: 700; color: var(--primary-dark); background: var(--primary-light); padding: 4px 10px; border-radius: 6px; direction: ltr; display: inline-block; }
        .pay-period { font-weight: 700; color: var(--text-dark); display: flex; align-items: center; gap: 8px;}
        
        .pay-amount { font-weight: 800; color: var(--text-dark); font-variant-numeric: tabular-nums; direction: ltr; display: inline-block; }
        ...
        <div class="page-body">
            ...
            <div class="toolbar">
                <div class="toolbar-right">
                    <h3><i class="fas fa-money-check-dollar"></i> سجل مسيرات الرواتب (Payrolls)</h3>
                </div>
                <div>
                    <a href="<?php echo URL_ROOT; ?>/payroll/create" class="btn-add">
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th>المرجع</th>
                                <th>عن شهر / سنة</th>
                                <th style="text-align:center;">إجمالي الموظفين</th>
                                <th style="text-align:left;">إجمالي الرواتب</th>
                                <th>تاريخ الإصدار</th>
                                <th>الحالة</th>
                                <th>الإجراءات</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><span class="pay-ref"><?php echo htmlspecialchars($pay->reference_no); ?></span></td>
                                <td>
                                ...
                                <td style="text-align:center; font-weight:700; color:var(--text-dark);"><?php echo $pay->total_employees; ?></td>
                                <td style="text-align:left;">
                                    <span class="pay-amount"><?php echo number_format($pay->total_net_amount, 2); ?> <span class="curr">ر.س</span></span>
                                </td>
                                <td><span style="font-size:12px;color:var(--text-muted);"><i class="far fa-clock"></i> <?php echo date('Y-m-d', strtotime($pay->created_at)); ?></span></td>
                                <td>
...
<a href="<?php echo URL_ROOT; ?>/payroll/show/<?php echo $pay->id; ?>" class="act-btn btn-view" title="عرض التفاصيل"><i class="fas fa-eye"></i></a>                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <h4>لا توجد مسيرات رواتب مصدرة</h4>
                                        <p>قم بإنشاء وإصدار مسير الرواتب الأول لتظهر البيانات هنا.</p>
                                    </div>
                                </td>
                            </tr>
                            <?php endif; ?>
