...
$pageTitle = $data['title'] ?? 'تعديل منتج';
...
<head>
    ...
    <title><?php echo $pageTitle; ?> — <?php echo htmlspecialchars($prod->name); ?></title>
                ...
                <div class="fhc-top">
                    <div class="fhc-title">
                        ...
                        <div>
                            ...
                            <p>قم بتحديث المعلومات ثم احفظ التغييرات</p>
                        </div>
                    </div>
                    <div class="fhc-product-badge">
                        <div>
                            <div class="fpb-sku"><?php echo htmlspecialchars($prod->sku); ?></div>
                            <div class="fpb-id">المعرّف المرجعي: #<?php echo $prod->id; ?></div>
                        </div>
                    </div>
                </div>
            </div>

            <!-- شريط معلومات سريعة للمنتج قبل التعديل -->
            <div class="prod-info-bar">
                <div class="pib-item">
                    <i class="fas fa-box"></i> المنتج: <strong><?php echo htmlspecialchars($prod->name); ?></strong>
                </div>
                <div class="pib-divider"></div>
                <div class="pib-item">
                    <i class="fas fa-cubes"></i> الكمية الحالية: <strong><?php echo $prod->quantity; ?> قطعة</strong>
                </div>
                <div class="pib-divider"></div>
                <div class="pib-item">
                    <i class="fas fa-tag"></i> السعر الحالي: <strong style="direction:ltr;"><?php echo number_format($prod->price, 2); ?> ر.س</strong>
                </div>
            </div>

            <!-- النموذج -->
            <div class="form-card" style="border-top-left-radius:0; border-top-right-radius:0; border-top:none;">
                <form action="<?php echo URL_ROOT; ?>/product/edit/<?php echo $prod->id; ?>" method="POST" id="productForm" novalidate>

                    <div class="form-section">
                        <div class="form-section-title"><span class="fst-icon fst-teal"><i class="fas fa-box"></i></span> البيانات الأساسية</div>
                        <div class="form-grid">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="price" class="form-input" id="prodPrice" value="<?php echo $prod->price; ?>" min="0" required style="direction:ltr;text-align:right;">
                            </div>
                            <div class="form-group">
                                <label class="form-label">إجمالي القيمة التقديرية بالمخزون</label>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/product/index" class="btn-cancel">إلغاء و العودة</a>
                    </div>
                </form>
            </div>
