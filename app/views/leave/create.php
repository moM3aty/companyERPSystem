<?php
$pageTitle = $data['title'] ?? 'تقديم طلب إجازة';
...
<head>
    ...
    <style>
        ...
        :root { --primary: #14b8a6; --primary-dark: #0d9488; --primary-light: #ccfbf1; --accent: #f59e0b; --accent-light: #fef3c7; --success: #22c55e; --success-light: #dcfce7; --danger: #ef4444; --danger-light: #fee2e2; --info: #06b6d4; --info-light: #cffafe; --purple: #8b5cf6; --purple-light: #ede9fe; --sidebar-w: 272px; --topbar-h: 68px; --page-bg: #f1f5f9; --card-bg: #ffffff; --text-dark: #0f172a; --text-body: #475569; --text-muted: #94a3b8; --border: #e2e8f0; --radius: 14px; --radius-sm: 10px; }
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-header-card { background: linear-gradient(135deg, var(--primary) 0%, #0d9488 100%); border-radius: var(--radius); padding: 28px 32px; color: #fff; margin-bottom: 24px; position: relative; overflow: hidden; animation: fadeUp 0.5s ease both; }
        ...
        .form-section-title .fst-icon { width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 14px; flex-shrink: 0; background: var(--primary-light); color: var(--primary-dark); }
        ...
        @media (max-width: 768px) { .sidebar { transform: translateX(100%); } .sidebar.open { transform: translateX(0); } .main-content { margin-right: 0; } .mobile-menu-btn { display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 10px; border: 1px solid var(--border); background: transparent; color: var(--text-body); font-size: 16px; cursor: pointer; } .page-body { padding: 20px 16px; } .topbar { padding: 0 16px; } .form-grid { grid-template-columns: 1fr; } }
        .sidebar-overlay { display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 99; backdrop-filter: blur(2px);} .sidebar-overlay.show { display: block; }
    </style>
</head>
<body>
    ...
    <div class="main-content">
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                ...
                <div>
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/leave/index">الإجازات</a>
                        <i class="fas fa-chevron-left" style="font-size:9px;"></i>
                        <span>تقديم طلب</span>
                    </div>
                </div>
        ...
        <div class="page-body">
            ...
            <div class="form-header-card">
                <h2><i class="fas fa-calendar-plus"></i> تقديم طلب إجازة جديد</h2>
                <p>قم بتحديد بيانات الإجازة، سيتم تحويل الطلب تلقائياً إلى الإدارة للمراجعة والاعتماد.</p>
            </div>

            <div class="form-card">
                <form action="<?php echo URL_ROOT; ?>/leave/create" method="POST" id="leaveForm">
                    <div class="form-section">
                        <div class="form-section-title"><span class="fst-icon"><i class="fas fa-file-signature"></i></span> تفاصيل الطلب</div>
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label class="form-label">نوع الإجازة <span class="req">*</span></label>
                            ...
                            <div class="form-group">
                                <label class="form-label">من تاريخ <span class="req">*</span></label>
                            ...
                            <div class="form-group full">
                                <label class="form-label">سبب الإجازة / ملاحظات <span class="req">*</span></label>
                                <textarea name="reason" class="form-input" rows="3" placeholder="اكتب مبررات الإجازة باختصار..." required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn-submit" id="btnSubmit"><i class="fas fa-paper-plane"></i> إرسال الطلب للاعتماد</button>
