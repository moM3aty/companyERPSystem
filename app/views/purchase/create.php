<?php
// المسار: app/views/purchase/create.php
...
<div class="card" style="max-width: 1000px; margin: 0 auto;">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-cart-plus text-primary"></i> إنشاء أمر شراء (PO)</h3>
    </div>
    ...
    <form action="<?php echo URLROOT; ?>/purchase/create" method="POST" id="poForm">
        <div class="card-body border-bottom">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="notes" class="form-control" placeholder="شروط التوصيل، الدفع، إلخ...">
                </div>
            </div>
        </div>
                ...
                <table class="table" style="border: 1px solid var(--border-color); border-radius: var(--radius-sm); overflow: hidden;">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="2" style="padding: 16px;"><span id="grandTotal" class="font-monospace fs-5 fw-bold text-success">0.00</span> ر.س</td>
                        </tr>
                    </tfoot>
                </table>
        ...
        <div class="card-footer d-flex gap-3">
            <button type="submit" class="btn btn-primary" id="submitBtn"><i class="fas fa-save"></i> حفظ أمر الشراء</button>
...
<script>
    ...
    document.getElementById('poForm').addEventListener('submit', () => {
        document.getElementById('submitBtn').innerHTML = '<i class="fas fa-circle-notch fa-spin"></i> جاري الحفظ...';
    });
</script>