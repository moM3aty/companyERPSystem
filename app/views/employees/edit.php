...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* استجابة */
        @media (max-width: 1024px) { .edit-header { grid-template-columns: 1fr; } }
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                ...
                <div>
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/employee/index">الموظفين</a>
                        <i class="fas fa-chevron-left" style="font-size:9px;"></i>
                ...
                <div class="form-header-card">
                    <div class="fhc-title">
                        ...
                        <div>
                            ...
                            <p>قم بتحديث البيانات المطلوبة ثم احفظ التعديلات</p>
                        </div>
                    </div>
                </div>

                <div class="emp-preview-card">
                    <div class="emp-preview-avatar"><?php echo mb_substr($emp->name, 0, 2); ?></div>
                    <div class="emp-preview-name"><?php echo htmlspecialchars($emp->name); ?></div>
                    <div class="emp-preview-pos"><?php echo htmlspecialchars($emp->position ?? 'بدون مسمى وظيفي'); ?></div>
                    <div class="emp-preview-stats">
                        <div class="eps-item">
                ...
                <form action="<?php echo URL_ROOT; ?>/employee/edit/<?php echo $emp->id; ?>" method="POST" id="empForm" novalidate>
                    ...
                    <div class="form-section">
                        <div class="form-section-title">
                            <span class="fst-icon fst-info"><i class="fas fa-user"></i></span>
                            البيانات الشخصية
                        </div>
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label">اسم الموظف <span class="req">*</span></label>
                                <input type="text" name="name" class="form-input" id="empName" value="<?php echo htmlspecialchars($emp->name); ?>" required>
                                <div class="form-hint"><i class="fas fa-info-circle"></i> الاسم الكامل كما يظهر في النظام</div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-hint"><i class="fas fa-envelope"></i> سيُستخدم للإشعارات</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        <div class="form-section-title">
                            <span class="fst-icon fst-amber"><i class="fas fa-briefcase"></i></span>
                            الوظيفة والقسم
                        </div>
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label">المسمى الوظيفي</label>
                                <input type="text" name="position" class="form-input" id="empPos" value="<?php echo htmlspecialchars($emp->position ?? ''); ?>" placeholder="مثال: مهندس برمجيات">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-section">
                        <div class="form-section-title">
                            <span class="fst-icon fst-purple"><i class="fas fa-money-check-dollar"></i></span>
                            بيانات مالية وتواصل
                        </div>
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label">رقم الهاتف</label>
                                <input type="text" name="phone" class="form-input" id="empPhone" value="<?php echo htmlspecialchars($emp->phone ?? ''); ?>" placeholder="05xxxxxxxx" style="direction:ltr;text-align:right;">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-hint"><i class="fas fa-coins"></i> الراتب الأساسي الشهري</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/employee/index" class="btn-cancel">
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!email.value.trim()) {
                ...
                email.parentNode.appendChild(makeErr('البريد الإلكتروني مطلوب'));
                valid = false;
            } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email.value)) {
                email.classList.add('has-error');
                email.parentNode.appendChild(makeErr('صيغة البريد الإلكتروني غير صحيحة'));
                valid = false;
            }
