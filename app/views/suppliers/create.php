    ...
    <div class="main-content">
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                ...
                <div>
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/supplier/index">الموردين</a>
                        <i class="fas fa-chevron-left" style="font-size:9px;"></i>
        ...
        <div class="page-body">
            ...
            <div class="form-header-card">
                <h2><i class="fas fa-truck-plus" style="margin-left:8px;"></i> إضافة مورد جديد</h2>
                <p>أدخل بيانات المورد — سيتم ربطه بأوامر الشراء والمدفوعات تلقائياً</p>
            </div>
            ...
            <div class="form-card">
                <form action="<?php echo URL_ROOT; ?>/supplier/create" method="POST" id="supplierForm" novalidate>
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input" id="supplierName" placeholder="مثال: شركة التقنية المحدودة" required>
                                <div class="form-hint"><i class="fas fa-info-circle"></i> الاسم كما سيظهر في أوامر الشراء</div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-hint"><i class="fas fa-building"></i> تحديد النوع يساعد في التقارير</div>
                            </div>
                            <div class="form-group full">
                                <label class="form-label">جهة الاتصال</label>
                                <input type="text" name="contact_person" class="form-input" id="supplierContact" placeholder="اسم الشخص المسؤول">
                                <div class="form-hint"><i class="fas fa-user-tie"></i> الشخص المسؤول عن التعامل مع المورد</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-input" id="supplierEmail" placeholder="info@company.com" style="direction:ltr;text-align:right;">
                                <div class="form-hint"><i class="fas fa-envelope"></i> سيُستخدم لإرسال أوامر الشراء</div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-hint"><i class="fas fa-mobile-screen"></i> رقم التواصل الرئيسي</div>
                            </div>
                            <div class="form-group full">
                                <label class="form-label">العنوان</label>
                                <textarea name="address" class="form-input" id="supplierAddress" placeholder="المدينة — الحي — الشارع — رقم المبنى" rows="2"></textarea>
                                <div class="form-hint"><i class="fas fa-location-dot"></i> عنوان المورد للتوصيل</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group full">
                            <textarea name="notes" class="form-input" id="supplierNotes" placeholder="أي ملاحظات إضافية عن المورد..." rows="3"></textarea>
                            <div class="form-hint"><i class="fas fa-info-circle"></i> ملاحظات داخلية لا تظهر للمورد</div>
                        </div>
                    </div>

                    <div class="form-actions">
                        <button type="submit" class="btn-submit" id="btnSubmit"><i class="fas fa-check-circle"></i> حفظ المورد</button>
                        <a href="<?php echo URL_ROOT; ?>/supplier/index" class="btn-cancel"><i class="fas fa-arrow-right"></i> رجوع للقائمة</a>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!name.value.trim() || name.value.trim().length < 3) {
                ...
                err.innerHTML = '<i class="fas fa-exclamation-circle"></i> اسم المورد مطلوب (3 أحرف على الأقل)';
