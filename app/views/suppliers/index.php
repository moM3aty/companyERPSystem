...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .summary-card:nth-child(1) .sc-icon {
            background: var(--info-light);
            color: var(--info);
        }

        .summary-card:nth-child(2) .sc-icon {
            background: var(--danger-light);
            color: var(--danger);
        }

        .summary-card:nth-child(3) .sc-icon {
            background: var(--success-light);
            color: var(--success);
        }
        ...
        .supplier-avatar.av-company {
            background: linear-gradient(135deg, var(--purple), #7c3aed);
        }

        .supplier-avatar.av-individual {
        ...
        <div class="page-body">
            ...
            <div class="summary-grid">
                <div class="summary-card">
                    <div class="sc-icon" style="background:var(--info-light);color:var(--info);"><i class="fas fa-truck"></i></div>
                    <div>
                ...
                <div class="summary-card">
                    ...
                    <div>
                        <div class="sc-label">إجمالي المستحقات (الدائنون)</div>
                        <div class="sc-value" style="color:var(--danger);"><?php echo number_format($totalPayables, 2); ?> <span class="sc-unit">ر.س</span></div>
                    </div>
                </div>
                <div class="summary-card">
                    <div class="sc-icon" style="background:var(--success-light);color:var(--success);"><i class="fas fa-check-circle"></i></div>
                    <div>
                        <div class="sc-label">موردون نشطون (بدون مديونية)</div>
                        <div class="sc-value" style="color:var(--success);">
                            <?php echo count(array_filter($suppliers, function ($s) {
                                return $s->balance == 0;
                            })); ?>
                        </div>
                    </div>
            ...
            <div class="toolbar">
                ...
                <div style="display:flex;align-items:center;gap:14px;">
                    <span class="result-count">عرض <strong id="visibleCount"><?php echo count($suppliers); ?></strong> مورد</span>
                    ...
                    <table>
                        ...
                        <tbody id="supplierBody">
                            <?php foreach ($suppliers as $s) :
                                ...
                                $initials = mb_substr($s->name ?? 'م', 0, 2);
                            ?>
                                <tr class="supplier-row" data-type="<?php echo $s->type; ?>" data-search="<?php echo htmlspecialchars($s->name . ' ' . ($s->phone ?? '') . ' ' . ($s->contact_person ?? '')); ?>">
                                    ...
                                    <td>
                                        <div class="supplier-cell">
                                            <div class="supplier-avatar <?php echo $avClass; ?>"><?php echo $initials; ?></div>
                                            <div>
                                                <div class="supplier-name">
                                                    <a href="<?php echo URL_ROOT; ?>/supplier/show/<?php echo $s->id; ?>" style="color:inherit;text-decoration:none;">
                                    ...
                                    <td>
                                        <div class="actions-cell">
                                            <a href="<?php echo URL_ROOT; ?>/supplier/show/<?php echo $s->id; ?>" class="act-btn btn-view" title="عرض"><i class="fas fa-eye"></i></a>
                                            <a href="<?php echo URL_ROOT; ?>/supplier/edit/<?php echo $s->id; ?>" class="act-btn btn-edit" title="تعديل"><i class="fas fa-pen-to-square"></i></a>
                                            <button class="act-btn btn-del" title="حذف" onclick="openDeleteModal(<?php echo $s->id; ?>, '<?php echo htmlspecialchars(addslashes($s->name)); ?>', <?php echo $s->balance; ?>)">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="empty-state">
                                            <i class="fas fa-truck-field-slash"></i>
                                            <h4>لا يوجد موردين مسجلين</h4>
                                            <p>ابدأ بإضافة أول مورد إلى قاعدة البيانات</p>
                                            <a href="<?php echo URL_ROOT; ?>/supplier/create" class="btn-add" style="display:inline-flex;">
                                                <i class="fas fa-plus"></i> إضافة مورد
                                            </a>
                                        </div>
                                    </td>
        ...
        <div class="modal-box">
            <div class="modal-header">
                ...
                <p id="balanceWarning" style="color:var(--danger);font-weight:600;font-size:12px;margin-top:8px;display:none;">
                    <i class="fas fa-exclamation-triangle"></i> تحذير: المورد لديه مستحقات (رصيد دائن)
                </p>
            </div>
