<?php
// app/views/contracts/create.php
$pageTitle = $data['title'] ?? 'تسجيل عقد جديد';
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-header-card { background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border-radius: var(--radius); padding: 28px 32px; color: #fff; margin-bottom: 24px; position: relative; overflow: hidden; animation: fadeUp 0.5s ease both; }
    ...
    <div class="main-content">
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                ...
                <div>
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo URL_ROOT; ?>/contract/index">إدارة العقود</a>
                        <i class="fas fa-chevron-left" style="font-size:9px;"></i>
                        <span>عقد جديد</span>
                    </div>
                </div>
        ...
        <div class="page-body">
            ...
            <div class="form-header-card">
                <h2><i class="fas fa-file-signature"></i> تسجيل عقد جديد</h2>
                <p>قم بإدخال بيانات العقد المرتبط بالعميل أو المورد لضمان استلام تنبيهات التجديد في الوقت المناسب.</p>
            </div>

            <div class="form-card">
                <form action="<?php echo URL_ROOT; ?>/contract/create" method="POST" id="contractForm" novalidate>
                    
                    <div class="form-section">
                        <div class="form-section-title"><span class="fst-icon fst-teal"><i class="fas fa-handshake"></i></span> الطرف المعني</div>
                        <div class="form-grid">
                            <div class="form-group full">
                                <label class="form-label">عنوان العقد <span class="req">*</span></label>
                                <input type="text" name="title" class="form-input" id="contractTitle" placeholder="مثال: عقد صيانة سنوي للفرع الرئيسي" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">نوع العقد <span class="req">*</span></label>
                                <select name="party_type" id="partyType" class="form-input" required>
                                    <option value="customer">عقد عميل</option>
                                    <option value="supplier">عقد مورد</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label">العميل / المورد <span class="req">*</span></label>
                                <select name="party_id" id="customerSelect" class="form-input" required>
                                    <option value="">-- اختر العميل --</option>
                                    <?php foreach($customers as $c): ?>
                                        <option value="<?php echo $c->id; ?>"><?php echo htmlspecialchars($c->name); ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <select name="party_id" id="supplierSelect" class="form-input" disabled style="display:none;">
                    ...
                    <div class="form-section">
                        <div class="form-section-title"><span class="fst-icon fst-purple"><i class="fas fa-calendar-check"></i></span> الشروط والتواريخ</div>
                        <div class="form-grid">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" min="0" name="value" class="form-input" placeholder="0.00" style="direction:ltr; text-align:right;">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group full">
                                ...
                                <textarea name="description" class="form-input" rows="3" placeholder="تفاصيل الدفعات، التجديد التلقائي..."></textarea>
                            </div>
                        </div>
                    </div>
                    
                    <div class="form-actions">
                        <button type="submit" class="btn-submit" id="btnSubmit"><i class="fas fa-save"></i> تسجيل العقد</button>
                        <a href="<?php echo URL_ROOT; ?>/contract/index" class="btn-cancel">إلغاء</a>
                    </div>
                </form>
            </div>
