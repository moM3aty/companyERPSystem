<?php
// المسار: app/views/sales_orders/create.php
...
<div class="card" style="max-width: 1000px; margin: 0 auto;">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-file-contract text-primary"></i> إنشاء أمر بيع جديد</h3>
    </div>
    ...
    <form action="<?php echo URLROOT; ?>/salesOrder/create" method="POST" id="soForm">
        ...
        <div class="card-footer d-flex gap-3">
            <button type="submit" class="btn btn-primary" id="submitBtn"><i class="fas fa-save"></i> حفظ أمر البيع</button>
