<?php
// المسار: app/views/sales_orders/edit.php
...
<div class="card" style="max-width: 1000px; margin: 0 auto;">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-pen text-accent"></i> تعديل أمر البيع: <?php echo htmlspecialchars($order->order_number); ?></h3>
    </div>
        ...
        <div class="card-body border-bottom">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="order_date" class="form-control" value="<?php echo date('Y-m-d', strtotime($order->order_date)); ?>" required>
                </div>
                ...
                <table class="table" style="border: 1px solid var(--border-color); border-radius: var(--radius-sm); overflow: hidden;">
                    ...
                    <tbody id="itemsBody">
                        ...
                        <tr class="item-row">
                            ...
                            <td style="padding: 12px;"><input type="number" name="price[]" step="0.01" min="0" class="form-control font-monospace price-input" oninput="calculateRow(this)" value="<?php echo $item->price; ?>" required></td>
                            <td style="padding: 12px;"><input type="number" name="quantity[]" min="1" class="form-control font-monospace qty-input" oninput="calculateRow(this)" value="<?php echo $item->quantity; ?>" required></td>
                            <td style="padding: 12px;"><input type="text" class="form-control font-monospace subtotal-input text-primary fw-bold" style="border:none; background:transparent;" value="<?php echo $item->subtotal; ?>" readonly></td>
